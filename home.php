...
if (isset($_POST['btn-keluar'])) { 
  $kode = $_POST['kode'];
  $jam_keluar = date('H:i');
  $cek_kode = mysqli_query($con, "SELECT COUNT(*) FROM tb_daftar_parkir WHERE kode='$kode'");
  if ($cek_kode==0) {
      echo "<script>alert('Kendaraan Tersebut Sudah Tidak Ada di Dalam Parkiran')</script>";
  }else{
    $sql = "UPDATE tb_daftar_parkir SET jam_keluar='$jam_keluar' WHERE kode='$kode'";
    $query = mysqli_query($con, $sql);        
    echo "<script>alert('Kendaraan Sudah keluar Parkiran')</script>";
  }
}
            ...
            <!-- Masuk Parkir -->
              ...
              <div class="col-md-5" style="margin-top: 30px">
                  <div class="col-md-10 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:25px;">
                      <div class="col-md-12">
                        <form class="cmxform" method="POST" name="btn-keluar">
                          <div class="col-md-12">
                          ...
                          <input class="btn btn-primary col-md-12" name="btn-keluar" type="submit" value="Go" style="height: 40px" id="btnKeluar" style="height: 40px">
                      </form>
                    </div>
                  </div>
                </div>
